...
OI::OI() {
	...
	servoButtonCenter = new JoystickButton(driverJoystick, 2);
	servoButtonCenter->WhenReleased(new ServoCenter());
	servoButtonLeft = new JoystickButton(driverJoystick, 3);
	servoButtonLeft->WhileHeld(new ServoLeft());
	servoButtonRight = new JoystickButton(driverJoystick, 4);
